...
const gem_version_1 = require("./gem-version");
const OPS = {
    '=': (v, r) => v.compare(r) === 0,
    '!=': (v, r) => v.compare(r) !== 0,
    '>': (v, r) => v.compare(r) > 0,
...
const quoted = Object.keys(OPS)
    ...
    .join('|');
const PATTERN_RAW = `\\s*(${quoted})?\\s*(${gem_version_1.GemVersion.VERSION_PATTERN})\\s*`;
// --
// A regular expression that matches a requirement
const PATTERN = new RegExp(`^${PATTERN_RAW}$`);
// --
// The default requirement matches any version
const DefaultRequirement = ['>=', new gem_version_1.GemVersion('0')];
class GemRequirement {
    ...
    static parse(obj) {
        if (obj instanceof gem_version_1.GemVersion) {
            return ['=', obj];
        }
        ...
        if (match[1] == '>=' && match[2] == '0') {
            ...
            return [match[1] || '=', new gem_version_1.GemVersion(match[2])];
        }
    }
    // --
    ...
    // end
    satisfiedBy(version) {
        if (!(version instanceof gem_version_1.GemVersion)) {
...
exports.GemRequirement = GemRequirement;
//# sourceMappingURL=gem-requirement.js.map